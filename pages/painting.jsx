    ...
    <div className={styles.SectionOne}>
      <div className={styles.TextOne}>
        ...
        <div className={styles.SmallText}>
          ...
          <h3>
            {" "}
            Tέχνη θεωρειται η ανθρώπινη δραστηριότητα ή δημιουργία που είναι
        ...
        <div className={styles.SmallText}>
          ...
          <h2> Τοιχογραφιες</h2>
          <h3>
            Αν σκοπευεται να κανετε μια τοιχογραφια στο δικο σας σπιτι θα
            φροντισουμε να σας το παραδωσουμε ταχυτητατα και ποιητικα οπως
            παρουσιαζουμε παρακατω δουλευοντας στον σχεδιασμο με συνεργασια μαζι
            σας. Η ζωγραφιες στους τοιχους γινονται απο ακρυλικα χρωματα
            ζωγραφικης.
          </h3>
        </div>
        <div className={styles.SmallText}>
          <h2>Αναπαλαιωνουμε επιπλα</h2>
          <h3>
            {" "}
            ...
            περισσότερα από αυτά είναι κατασκευασμένα από μασίφ ξύλο.Περιληπτικα
            η διαδικασια ειναι ξυσιμο και μετα σχεδιασμος του επιπλου.
          </h3>
        </div>
      </div>
      {width > 1000 ? (
  ...
  return (
    <div>
      <AnimatePresence exitBeforeEnter>
        ...
        <LastComponent
          Title="Κοιταξτε και καποιες απo τις δουλειες μας !"
          Text="  Εδω παρουσιαζουμε καποιες τελειωμενες ανακαινισεις σπιτιου. Για να παρετε και εσεις μια γευμη και καποιες ιδεες για μελλοντικες δουλειες !  "
